        ...
        <div className="container">
            <div className="row">
                <div className="col-12 col-lg-6 d-flex align-items-center justify-content-center mb-4 mb-lg-0">
                    <h1 className="fw-semibold testimonial-heading display-4 text-dark text-lg-start text-center mb-2">
                    50+ <span className="font-purple">full-stack projects </span>delivered
                    </h1>
                </div>
                <div className="col-12 testimonials col-lg-6 d-flex align-items-center justify-content-center">
                    <div
                    ...
                    <div className="carousel-inner">
                        ...
                        <h5 className="fw-400 letter-spacing-sm centered-description text-lg-start text-center">
